...
namespace EventCatalogAPI.Data
{
    public class CatalogSeed
    {
        ...
        private static IEnumerable<Catagory> GetPreConfigeredCatagories()
        {
            ...
            {
                new Catagory() { CatagoryName = "Music"},
                new Catagory() { CatagoryName = "Food & Drink"},
                new Catagory() { CatagoryName = "Arts"},
                new Catagory() { CatagoryName = "Business"},
                new Catagory() { CatagoryName = "Parties"},
                new Catagory() { CatagoryName = "Classes"},
                new Catagory() { CatagoryName = "Sport"}
            };
        }
